...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" ref={ref} className="py-16 md:py-24 border-t border-white/[0.08] bg-[#050508] relative overflow-hidden">
            ...
            return (
              <div
                ...
                className={`cursor-pointer rounded-2xl sm:rounded-3xl p-6 sm:p-7 flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 group relative overflow-hidden ${
                  isFeatured
                    ? 'bg-gradient-to-b from-[#130f24] via-[#0d0c16] to-[#08080e] border-2 border-purple-500/40 hover:border-purple-400/80 shadow-xl shadow-purple-950/20 hover:shadow-2xl hover:shadow-purple-600/25'
                    : 'bg-[#09090f] border border-white/[0.08] hover:border-purple-500/40 hover:shadow-xl hover:shadow-purple-950/20'
                }`}
                style={{
                  opacity: inView ? 1 : 0,
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  {/* Title & Description */}
                  <div>
                    <h3 className={`${isFeatured ? 'text-2xl font-black' : 'text-xl font-bold'} text-white group-hover:text-purple-300 transition-colors tracking-tight`}>
                      {project.title}
                    </h3>
