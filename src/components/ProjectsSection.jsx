...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" ref={ref} className="py-16 md:py-24 border-t border-[#DFB6B2]/10 bg-[#190019] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-normal font-display text-[#FBE4D8] tracking-tight">
            Applied Systems &amp; Engineering
          </h2>
          <p className="text-[#DFB6B2]/80 text-xs sm:text-sm leading-relaxed">
            ...
            return (
              <div
                ...
                className={`cursor-pointer rounded-2xl sm:rounded-3xl p-6 sm:p-7 flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 group relative overflow-hidden ${
                  isFeatured
                    ? 'bg-gradient-to-b from-[#35165E] via-[#2B124C] to-[#190019] border-2 border-[#854F6C]/60 hover:border-[#DFB6B2]/80 shadow-xl shadow-black/60 hover:shadow-2xl hover:shadow-[#854F6C]/30'
                    : 'bg-[#2B124C] border border-[#DFB6B2]/12 hover:border-[#854F6C]/60 hover:shadow-xl hover:shadow-black/70'
                }`}
                style={{
                  opacity: inView ? 1 : 0,
              ...
              >
                ...
                <div 
                  ...
                  style={{
                    background: isFeatured
                      ? 'radial-gradient(circle 220px at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(223, 182, 178, 0.15), transparent 70%)'
                      : 'radial-gradient(circle 180px at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(223, 182, 178, 0.10), transparent 70%)'
                  }}
                />

                {/* Featured Glow Highlight Line */}
                {isFeatured && (
                  <div className="absolute top-0 right-8 w-28 h-[2px] bg-gradient-to-r from-transparent via-[#DFB6B2] to-transparent"></div>
                )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] font-mono text-[#DFB6B2] uppercase tracking-wider font-semibold">
                        {project.category}
                      </span>
                      {isFeatured && (
                        <span className="text-[9px] font-mono font-bold text-[#FBE4D8] bg-[#522B5B] px-2 py-0.5 rounded-full border border-[#854F6C]/40">
                          FEATURED
                        </span>
                      )}
                    </div>
                    <span className="text-[10px] font-mono text-[#DFB6B2]/70 bg-[#190019]/60 px-2.5 py-0.5 rounded-full border border-[#DFB6B2]/10">
                      {project.role}
                    </span>
                  </div>
                  ...
                  {/* Title & Description */}
                  <div>
                    <h3 className={`${isFeatured ? 'text-2xl sm:text-3xl' : 'text-xl sm:text-2xl'} font-display font-normal text-[#FBE4D8] group-hover:text-[#DFB6B2] transition-colors tracking-tight`}>
                      {project.title}
                    </h3>
                    <p className="text-xs text-[#DFB6B2]/80 font-medium mt-1.5 leading-snug">
                      {project.tagline}
                    </p>
                  </div>

                  {/* Contribution */}
                  <div className="pt-2.5 border-t border-[#DFB6B2]/10">
                    <span className="text-[10px] font-mono uppercase tracking-wider text-[#DFB6B2]/60 block mb-1">
                      System Contribution
                    </span>
                    <p className="text-xs text-[#DFB6B2]/85 leading-relaxed">
                    ...
                    {project.technologies.slice(0, 4).map((t, tIdx) => (
                      <span
                        ...
                        className={`text-[10px] font-mono px-2 py-0.5 rounded-md border ${
                          isFeatured 
                            ? 'bg-[#522B5B] border-[#854F6C]/50 text-[#FBE4D8]' 
                            : 'bg-[#190019]/50 border-[#DFB6B2]/10 text-[#DFB6B2]/80'
                        }`}
                      >
                        {t}
                      </span>
                ...
                {/* Action Button */}
                <div className="pt-5 mt-5 border-t border-[#DFB6B2]/10">
                  <span
                    className={`text-xs font-semibold flex items-center gap-1 group/btn transition-colors ${
                      isFeatured ? 'text-[#DFB6B2] group-hover:text-[#FBE4D8]' : 'text-[#DFB6B2] group-hover:text-[#FBE4D8]'
                    }`}
                  >
      ...
      {activeProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/85 backdrop-blur-xl animate-fade-in">
          ...
          <div className="relative w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-3xl bg-[#2B124C] border border-[#854F6C]/50 p-6 sm:p-8 shadow-2xl z-10 space-y-4">
            
            <div className="flex items-start justify-between border-b border-[#DFB6B2]/15 pb-4">
              <div>
                <span className="text-xs font-mono uppercase text-[#DFB6B2] font-semibold">
            ...
            <div className="space-y-3 text-xs sm:text-sm">
              <div className="p-4 rounded-xl bg-[#190019]/60 border border-[#DFB6B2]/10 space-y-1">
                <span className="font-mono text-[#DFB6B2] font-bold uppercase block text-xs">
                  Overview
                </span>
              ...
              <div className="p-4 rounded-xl bg-[#522B5B]/50 border border-[#854F6C]/40 space-y-1">
                <span className="font-mono text-[#FBE4D8] font-bold uppercase block text-xs">
              ...
              <div className="pt-2">
                <span className="text-xs font-mono uppercase text-[#DFB6B2] block mb-2">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {activeProject.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="px-2.5 py-1 rounded-md bg-[#190019]/60 border border-[#DFB6B2]/12 text-[#DFB6B2] font-mono text-xs"
                    >
                      {tech}
                    </span>
                  ))}
