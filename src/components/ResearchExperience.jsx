...
export default function ResearchExperience() {
  ...
  return (
    <section id="research" ref={ref} className="py-20 md:py-32 border-t border-white/[0.08] bg-[#050508] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Clean Section Header with Reveal */}
        <div 
          className="max-w-3xl mb-12 space-y-2 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
          style={{
            opacity: inView ? 1 : 0,
        ...
        >
          <div className="text-[11px] font-mono uppercase tracking-widest text-purple-400 font-semibold flex items-center gap-2">
            ...
            <span>Research &amp; Market Intelligence</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center mb-10">
          ...
          >
            <div 
              data-spotlight
              className="p-6 rounded-2xl bg-[#09090f] border border-white/[0.08] hover:border-purple-500/40 space-y-3 relative overflow-hidden group shadow-lg transition-all duration-300"
            >
              ...
              <div className="flex items-baseline gap-3">
                <span className="text-5xl sm:text-6xl font-extrabold text-white font-mono tracking-tighter">
                  100+
                </span>
