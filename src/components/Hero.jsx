...
export default function Hero() {
  ...
  return (
    <section 
      id="hero"
      className="relative min-h-[85vh] lg:min-h-[88vh] flex items-center pt-24 pb-16 sm:pt-28 sm:pb-20 overflow-hidden bg-[#050507]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-7 sm:space-y-8">
            ...
            <div className="space-y-3">
              {/* 1. Name reveals first */}
              <h1 
                className={`text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white uppercase font-sans transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
            ...
            >
              <p className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-zinc-100 tracking-tight leading-snug max-w-xl">
                I build ideas into{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-violet-300 to-indigo-300 font-bold">
                  products,
                </span>{" "}
