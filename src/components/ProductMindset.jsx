    ...
    <section id="mindset" ref={ref} className="py-20 md:py-32 border-t border-white/[0.08] bg-[#050508] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-bold font-display text-white tracking-tight leading-[1.12]">
            ...
            return (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <h3 className="text-base sm:text-lg font-bold font-display text-white group-hover:text-purple-300 transition-colors leading-snug">
                    {item.question}
                  </h3>
